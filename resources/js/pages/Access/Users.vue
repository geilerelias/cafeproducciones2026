    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <main class="min-h-screen overflow-x-hidden bg-zinc-50 p-3 sm:p-4 md:p-6">
            ...
            <section class="mt-6 rounded-md border border-zinc-200 bg-white p-5 shadow-sm">
                ...
                <form class="mt-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-[1fr_1fr_1fr_1fr_auto]" @submit.prevent="createForm.post(route('access.users.store'), { preserveScroll: true, onSuccess: () => createForm.reset() })">
